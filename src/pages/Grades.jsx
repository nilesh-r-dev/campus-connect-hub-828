      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="space-y-8">
          <Card>
            ...
            <CardContent>
              {submissions.length === 0 ? (<p className="text-center text-muted-foreground py-8">No submissions yet</p>) : (<Table>
                  <TableHeader>
                    <TableRow>
                  ...
                  <TableBody>
                    {submissions.map((submission) => (<TableRow key={submission.id}>
                        ...
                        <TableCell>
                          {submission.grade !== null ? (<span className="font-semibold">
                              {submission.grade}/{submission.assignments?.total_points}
                            </span>) : (<span className="text-muted-foreground">Not graded</span>)}
                        </TableCell>
                        <TableCell>
          ...
          <Card>
            ...
            <CardContent>
              {quizAttempts.length === 0 ? (<p className="text-center text-muted-foreground py-8">No quiz attempts yet</p>) : (<Table>
                  <TableHeader>
                    <TableRow>
                  ...
                  <TableBody>
                    {quizAttempts.map((attempt) => (<TableRow key={attempt.id}>
