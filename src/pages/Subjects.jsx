    ...
    return (<div className="min-h-screen bg-gradient-to-br from-primary/5 via-background to-secondary/5">
      <header className="border-b bg-card shadow-sm">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          {userRole === "faculty" && (<Dialog open={open} onOpenChange={setOpen}>
      ...
      <main className="container mx-auto px-4 py-8">
        {subjects.length === 0 ? (<div className="text-center py-16">
            ...
            {subjects.map((subject) => (<Card key={subject.id} className="hover:shadow-lg transition-all">
                <CardHeader>
                ...
                <CardContent>
                  ...
                  {userRole === "student" && (<Button className="w-full" disabled={enrolledSubjects.has(subject.id)} onClick={() => handleEnroll(subject.id)}>
