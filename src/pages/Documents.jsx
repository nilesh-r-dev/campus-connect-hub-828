    ...
    return (<div className="min-h-screen bg-gradient-to-br from-primary/5 via-background to-secondary/5">
      ...
      <main className="container mx-auto px-4 py-8">
        <Tabs defaultValue="all" className="w-full">
          ...
          <TabsContent value="all">
            {documents.length === 0 ? (<div className="text-center py-16 animate-fade-in">
                ...
                {documents.map((doc, index) => (<Card key={doc.id} className="hover:shadow-lg transition-all animate-fade-in hover:-translate-y-1" style={{ animationDelay: `${index * 0.1}s` }}>
                    <CardHeader>
                      <div className="flex items-start justify-between">
                        ...
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end">
                            ...
                            <DropdownMenuItem className="text-destructive focus:text-destructive" onClick={() => setDeleteDoc(doc)}>
                    ...
                    <CardContent>
                      ...
                      <Button variant="secondary" className="w-full" onClick={() => window.open(doc.file_url, '_blank')}>
                        View Document
                      </Button>
                    </CardContent>
                  </Card>))}
      ...
      <Dialog open={!!editDoc} onOpenChange={(open) => !open && setEditDoc(null)}>
        <DialogContent>
          ...
          <Input value={editTitle} onChange={(e) => setEditTitle(e.target.value)} placeholder="New document title"/>
          <DialogFooter>
