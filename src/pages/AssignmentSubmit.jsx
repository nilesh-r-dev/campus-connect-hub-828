        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              {assignment?.due_date && (<div className="flex items-center gap-2">
            ...
            {submission ? (<div className="bg-muted/50 p-4 rounded-lg space-y-2">
                <h3 className="font-semibold">Your Submission</h3>
                <p className="text-sm text-muted-foreground">
                  Status: <span className="font-medium capitalize">{submission.status}</span>
                </p>
                {submission.grade !== null && (<p className="text-sm text-muted-foreground">
