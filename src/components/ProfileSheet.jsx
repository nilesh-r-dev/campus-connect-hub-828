...
export function ProfileSheet({ open, onOpenChange, profile, userRole, onProfileUpdate }) {
            ...
            <div className="space-y-2">
              ...
              <Popover open={collegeOpen} onOpenChange={setCollegeOpen}>
                <PopoverTrigger asChild>
                  <Button variant="outline" role="combobox" aria-expanded={collegeOpen} className="w-full justify-between text-left font-normal">
                ...
                <PopoverContent className="w-[350px] p-0" align="start">
                  <Command>
                    ...
                    <CommandList>
                      ...
                      <CommandGroup>
                        {colleges.map((college) => (<CommandItem key={college.id} value={`${college.name} ${college.location} ${college.state}`} onSelect={() => {
              ...
              {!collegeId && (<p className="text-sm text-destructive">
